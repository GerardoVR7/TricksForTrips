...
# url = 'https://sandbox-api.openpay.mx/v1/m3zwajjoabqmrgg9dk3p/customers'
# @openpay_router.post("/payments", tags=["Payments"])
# async def create_booking(token : Customer):

#     try:
#         customer = openpay.Customer.create(url,token)
#         print(customer)
